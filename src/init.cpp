...
void Shutdown()
{
    ...
    RenameThread("kitehcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Kitehcoin/Kitehcoin-core>";
    const std::string URL_WEBSITE = "<https://kitehcoin.org/>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("kitehcoin-loadblk");
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Kitehcoin: Do we need to do any RPC mining init here?

...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Kitehcoin Core repository on GitHub"),
        tr("Services that claim to double your kitehcoins are always ponzi schemes")
    };

...
#define QAPP_ORG_NAME "Kitehcoin"
#define QAPP_ORG_DOMAIN "kitehcoin.org"
#define QAPP_APP_NAME_DEFAULT "Kitehcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Kitehcoin-Qt-testnet"

...
/* Dogecoin 1.14.5: set the wallet's discard threshold to 1 KITEH because that's what 97%
 ...
 */
/* Dogecoin 1.14.6: set the wallet's discard threshold to 0.01 KITEH. Very network
...
/*
 * Kitehcoin: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * Kitehcoin: Creating change outputs at exactly the dustlimit is counter-
...
public:
    ...
    /**
     * Kitehcoin: Get a fee targetting a specific transaction speed.
     */
    CAmount GetKitehcoinPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed);
    /**
     * Kitehcoin: Get a fee targetting a specific transaction speed.
     */
    static CAmount GetKitehcoinPriorityFee(const CMutableTransaction& tx, unsigned int nTxBytes, FeeRatePreset nSpeed, CAmount targetFee);
    /**
    ...
    /**
     * Return the minimum required fee taking into account the
     * floating relay fee and user set minimum transaction fee, but not the Kitehcoin dust fee.
     */

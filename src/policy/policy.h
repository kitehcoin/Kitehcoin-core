 ...
 *
 *  Kitehcoin:    Increment mempool limits and accept RBF in steps of 0.0001 KITEH
...
/**
 * Kitehcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Kitehcoin: Default hard dust limit that is evaluated when considering whether

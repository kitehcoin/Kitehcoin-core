...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kitehcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kitehcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kitehcoin transaction") + "\n" +
              "  kitehcoin-tx [options] -create [commands]   " + _("Create hex-encoded kitehcoin transaction") + "\n" +
              "\n";

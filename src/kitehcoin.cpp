...
// Kitehcoin: Normally minimum difficulty blocks can only occur in between
...
unsigned int CalculateKitehcoinNextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
{
...
CAmount GetKitehcoinBlockSubsidy(int nHeight, const Consensus::Params& consensusParams, uint256 prevHash)
{
    ...
    else 
    {
        ...
        if (nHeight < 2000)
            ...
            return 10000 * COIN; // Constant inflation for blocks >= 220,000
    }
}
